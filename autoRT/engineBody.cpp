...
/*******************************************************************
* Function Name: EngineBody
* Description: 
********************************************************************/
EngineBody::EngineBody( const string &name )
: Atomic( name )
, in( addInputPort( "in" ) )
...
* Description: 
********************************************************************/
Model &EngineBody::externalFunction( const ExternalMessage &msg )
{
	if( msg.port() == in )
	{
		int n=(int) msg.value();
...
* Description: 
********************************************************************/
Model &EngineBody::internalFunction( const InternalMessage & )
{
	passivate();
	return *this ;
}
...
* Description: 
********************************************************************/
//Model &EngineBody::outputFunction( const InternalMessage &msg )
Model &EngineBody::outputFunction( const CollectMessage &msg )
{
